...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul  2 02:21:45 2017
...
def main():
    ...
    tweets_data_path = '/home/hdusr/AnacondaProjects/Python/twitter_data.txt'     
    ...
    plt.bar(x_pos, tweets_by_prg_lang, width,alpha=1,color='g')
    ax.set_ylabel('Number of tweets', fontsize=15)
    ax.set_title('Ranking: python vs. javascript vs.Streams ruby (Relevant data)', fontsize=10, fontweight='bold')
    ax.set_xticks([p + 0.4 * width for p in x_pos])
    ax.set_xticklabels(prg_langs)
    plt.grid()
